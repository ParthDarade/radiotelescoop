    ...
    <div class="wrap-contact100">
        <form  action="" class="contact100-form validate-form" method="POST">
				<span class="contact100-form-title">
					RadScope Telescope Control
					<hr>
				<center><font color="1E90FF" size="4"><b>ⓘ New to radio astronomy?</b></font><font color="1E90FF" size="3"><br>Click <b><u><a href="Observing_the_radio_sky_with_PICTOR.pdf" target="_blank"><font color="7BB33A" size="3">here</font></a></u></b> to learn how to use <b>PICTOR and other telescopes</b> and observe the radio sky!<hr></font>
                    <?php
...
-->
<hr>
            <b> I would like to sincerely thank Dr. Udupikar and team for sponsoring the Raspberry Pi, RTL SDR and the Nooelec SAWBird H1 LNA. I would also thank Mr. Shirish Deshmukh for providing roof, accomodation and monetary help. I express my gratitude to Mr. Makrand Vaidya and Dr. Prutha Kulkarni for providing us with support with the LMR 400 cable. I also express my heartfelt thanks to VU2MSB Mr. Bhagwat for providing us with the C band dish antenna.
            <br><br>
            <p style="font-size:95%;">Contact: <a style="font-size:95%;" href="mailto:parth.d.darade@gmail.com">parth.d.darade@gmail.com</a></p>
            <p style="font-size:95%;">PICTOR GitHub: <a style="font-size:95%;" href="https://github.com/0xCoto/PICTOR" target="_blank">https://github.com/0xCoto/PICTOR</a></p>
